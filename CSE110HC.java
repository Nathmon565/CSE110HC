...
class CSE110HC {
	...
	private void Run() {
		...
		while (true) {
			switch (status) {
				case menu:
					int choice = IntInput("1) Start Game\n2) Set Seed\n", 1, 1, 2);
					switch (choice) {
						case 1:
							...
							break;
						case 2:
							random = new Random(IntInput("Enter a seed: "));
							break;
					}
